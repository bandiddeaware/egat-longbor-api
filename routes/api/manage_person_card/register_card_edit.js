...
router.patch('/registor_card', auth.required, async function(req, res, next) {
  if (!req.body.card_id){
  ...
  const result = await registercard.Edit(req.body.card_id, req.body.uhf_code, req.body.mifare_code,)
